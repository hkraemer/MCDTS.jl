...
method1 = 0; % set 1: full (one embedding for all time series), 
             % set 0: for each time series a new embedding
             
sample = 2;  % set 1: sample 1, set 2: sample 2
...
ylabel('correlation')
title(strcat('CCM for sample ',num2str(sample),'{ }','x1'))
...
xlabel('time series length')
ylabel('correlation')
title(strcat('CCM for sample ',num2str(sample),'{ }','x2'))
set(gca, 'LineWidth',2, 'Fontsize',fs)
ylim([-0.1 1])
...
xlabel('time series length')
ylabel('correlation')
title(strcat('CCM for sample ',num2str(sample),'{ }','y1'))
set(gca, 'LineWidth',2, 'Fontsize',fs)
ylim([-0.1 1])
...
xlabel('time series length')
ylabel('correlation')
title(strcat('CCM for sample ',num2str(sample),'{ }','y2'))
set(gca, 'LineWidth',2, 'Fontsize',fs)
ylim([-0.1 1])