...
writestr = "./slow and fast variable/results_Lorenz96_L2_N$(N)_M$(M)_2d_tau_mcdts.csv"
writedlm(writestr, best_node.τs)
writestr = "./slow and fast variable/results_Lorenz96_L2_N$(N)_M$(M)_2d_ts_mcdts.csv"
writedlm(writestr, best_node.ts)
writestr = "./slow and fast variable/results_Lorenz96_L2_N$(N)_M$(M)_2d_optimal_d_mcdts.csv"
writedlm(writestr, optimal_d_mcdts)
writestr = "./slow and fast variable/results_Lorenz96_L2_N$(N)_M$(M)_2d_L_mcdts.csv"
