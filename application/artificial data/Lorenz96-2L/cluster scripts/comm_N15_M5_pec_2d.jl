...
writestr = "./slow and fast variable/results_Lorenz96_L2_N$(N)_M$(M)_2d_tau_pec.csv"
writedlm(writestr, τ_pec)
writestr = "./slow and fast variable/results_Lorenz96_L2_N$(N)_M$(M)_2d_ts_pec.csv"
writedlm(writestr, ts_pec)
writestr = "./slow and fast variable/results_Lorenz96_L2_N$(N)_M$(M)_2d_optimal_d_pec.csv"
writedlm(writestr, optimal_d_pec)
writestr = "./slow and fast variable/results_Lorenz96_L2_N$(N)_M$(M)_2d_L_pec.csv"
writedlm(writestr, sum(Ls_pec))
writestr = "./slow and fast variable/results_Lorenz96_L2_N$(N)_M$(M)_2d_ts.csv"
