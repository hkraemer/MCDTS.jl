...
Y_mcdts_PRED_multi_n = MCDTS.genembed_for_prediction(data_sample_n, τ_mcdts_PRED_multi_n, ts_mcdts_PRED_multi_n)

# Save data
writedlm("Y_mcdts_PRED_multi_5_n.csv", Y_mcdts_PRED_multi_n)
writedlm("tau_mcdts_PRED_multi_5_n.csv", τ_mcdts_PRED_multi_n)
writedlm("ts_mcdts_PRED_multi_5_n.csv", ts_mcdts_PRED_multi_n)
