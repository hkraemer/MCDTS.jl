...
# Save data
writedlm("Y_mcdts_PRED_multi_5.csv", Y_mcdts_PRED_multi)
writedlm("tau_mcdts_PRED_multi_5.csv", τ_mcdts_PRED_multi)
writedlm("ts_mcdts_PRED_multi_5.csv", ts_mcdts_PRED_multi)
