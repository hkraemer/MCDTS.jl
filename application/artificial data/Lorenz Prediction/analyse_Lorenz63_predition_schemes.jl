...
KK = 5 # number of nearest neighbours for zeroth predictor
...
begin
    ...
    # writedlm("./application/artificial data/Lorenz Prediction/Results 6/mcdts_zeroth.csv",mcdts_zeroth)
    ...
    # writedlm("./application/artificial data/Lorenz Prediction/Results 6/mcdts_zeroth_n.csv",mcdts_zeroth_n)
    # mcdts_zeroth2_n = MCDTS.iterated_local_zeroth_prediction(Y_mcdts2_n, KK, T_steps; theiler = w1_n, verbose=true)
    # writedlm("./application/artificial data/Lorenz Prediction/Results 6/mcdts_zeroth.csv",mcdts_zeroth2_n)
    # println("mcdts FNN:")
    # println("*****")
...
load = begin
    ...
    mcdts_PRED_zeroth = Dataset(readdlm("./application/artificial data/Lorenz Prediction/Results $Number/mcdts_PRED_zeroth.csv"))
    mcdts_PRED_zeroth2 = Dataset(readdlm("./application/artificial data/Lorenz Prediction/Results $Number/mcdts_PRED_zeroth2.csv"))
    mcdts_PRED_zeroth_n = Dataset(readdlm("./application/artificial data/Lorenz Prediction/Results $Number/mcdts_PRED_zeroth_n.csv"))
    mcdts_PRED_zeroth2_n = Dataset(readdlm("./application/artificial data/Lorenz Prediction/Results $Number/mcdts_PRED_zeroth.csv"))
    mcdts_PRED_5_zeroth = Dataset(readdlm("./application/artificial data/Lorenz Prediction/Results $Number/mcdts_PRED_5_zeroth.csv"))
    mcdts_PRED_5_zeroth2 = Dataset(readdlm("./application/artificial data/Lorenz Prediction/Results $Number/mcdts_PRED_5_zeroth2.csv"))
    mcdts_PRED_5_zeroth_n = Dataset(readdlm("./application/artificial data/Lorenz Prediction/Results $Number/mcdts_PRED_5_zeroth_n.csv"))
    mcdts_PRED_5_zeroth2_n = Dataset(readdlm("./application/artificial data/Lorenz Prediction/Results $Number/mcdts_PRED_5_zeroth.csv"))
end
...
begin
    ...
    subplot(121)
    plot(t2[1:T_steps], MSE_zeroth_mcdts2, "y.-", label="MCDTS L 2")
    plot(t2[1:T_steps], MSE_zeroth_mcdts, "yo--", label="MCDTS L")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_fnn2, "yv-", label="MCDTS FNN 2")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_fnn, "y<-", label="MCDTS FNN")
    plot(t2[1:T_steps], MSE_zeroth_pec2, "ro-", label="PECUZAL 2")
    plot(t2[1:T_steps], MSE_zeroth_pec, "r.-.", label="PECUZAL")
    plot(t2[1:T_steps], MSE_zeroth_cao, "k<--", label="CAO")
    plot(t2[1:T_steps], MSE_zeroth_kennel, "kv-", label="Kennel")
    plot(t2[1:T_steps], MSE_zeroth_hegger, "ko-.", label="Hegger")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED2, "bo-", label="MCDTS PRED 2")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED, "bv-", label="MCDTS PRED")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED2_5, "b<--", label="MCDTS PRED 2 5 Tw")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED_5, "b>-.", label="MCDTS PRED 5 Tw")
    legend()
    ...
    subplot(122)
    plot(t2[1:T_steps], MSE_zeroth_mcdts2_n, "y.-", label="MCDTS L 2")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_n, "yo--", label="MCDTS L")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_fnn2_n, "yv-", label="MCDTS FNN 2")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_fnn_n, "y<-", label="MCDTS FNN")
    plot(t2[1:T_steps], MSE_zeroth_pec2_n, "ro-", label="PECUZAL 2")
    plot(t2[1:T_steps], MSE_zeroth_pec_n, "r.-.", label="PECUZAL")
    plot(t2[1:T_steps], MSE_zeroth_cao_n, "k<--", label="CAO")
    plot(t2[1:T_steps], MSE_zeroth_kennel_n, "kv-", label="Kennel")
    plot(t2[1:T_steps], MSE_zeroth_hegger_n, "ko-.", label="Hegger")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED2_n, "bo-", label="MCDTS PRED 2")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED_n, "bv-", label="MCDTS PRED")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED2_5_n, "b<--", label="MCDTS PRED 2 5 Tw")
    plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED_5_n, "b>-.", label="MCDTS PRED 5 Tw")
    legend()
...
figure()
# plot(t2[1:T_steps], MSE_zeroth_mcdts2, "y.-", label="MCDTS L 2")
# plot(t2[1:T_steps], MSE_zeroth_mcdts, "y--", label="MCDTS L")
# plot(t2[1:T_steps], MSE_zeroth_mcdts_fnn2, "y-", label="MCDTS FNN 2")
# plot(t2[1:T_steps], MSE_zeroth_mcdts_fnn, "y-.", label="MCDTS FNN")
...
# #plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED2, "b-", label="MCDTS PRED 2")
# plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED, "b-", label="MCDTS PRED")
# #plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED2_5, "b-", label="MCDTS PRED 2 5 Tw")
# plot(t2[1:T_steps], MSE_zeroth_mcdts_PRED_5, "b-.", label="MCDTS PRED 5 Tw")
legend()
title("Forecast Error (ZEROTH predictor)")
