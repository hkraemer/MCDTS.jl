...
# load results
begin
    MSEs[1,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_cao.csv")
    MSEs[2,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_kennel.csv")
    MSEs[3,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_hegger.csv")
    MSEs[4,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_pec.csv")
    MSEs[5,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_pec2.csv")
    MSEs[6,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts_L.csv")
    MSEs[7,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts2_L.csv")
    MSEs[8,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts_FNN.csv")
    MSEs[9,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts2_FNN.csv")
    MSEs[10,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts_PRED.csv")
    MSEs[11,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts2_PRED.csv")
    MSEs[12,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts_PRED_KL.csv")
    MSEs[13,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts2_PRED_KL.csv")

    MSEs_n[1,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_cao_n.csv")
    MSEs_n[2,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_kennel_n.csv")
    MSEs_n[3,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_hegger_n.csv")
    MSEs_n[4,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_pec_n.csv")
    MSEs_n[5,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_pec2_n.csv")
    MSEs_n[6,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts_L_n.csv")
    #MSEs_n[7,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts2_L_n.csv")
    MSEs_n[8,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts_FNN_n.csv")
    MSEs_n[9,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts2_FNN_n.csv")
    MSEs_n[10,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts_PRED_n.csv")
    MSEs_n[11,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts2_PRED_n.csv")
    MSEs_n[12,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts_PRED_KL_n.csv")
    MSEs_n[13,:,:] = readdlm("./application/artificial data/Roessler Prediction/Results 2/results_Roessler_MSEs_mcdts2_PRED_KL_n.csv")
...
begin
    ...
    figure(figsize=(20,10))
    subplot(121)
    bar(1:13, vec(mean(times,dims=2)))
    xticks(ticks=1:13, labels=methods, rotation=90)
    grid()
    ylabel("Lyapunov time")
    title("Normalized mean squared Prediction error larger than $threshold (NO NOISE)")
    ...
    subplot(122)
    bar(1:13, vec(mean(times_n,dims=2)))
    xticks(ticks=1:13, labels=methods, rotation=90)
    grid()
    ylabel("Lyapunov time")
    title("Normalized mean squared Prediction error larger than $threshold (NOISY)")
