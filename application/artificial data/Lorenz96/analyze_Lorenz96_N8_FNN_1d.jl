...
tau_tde = Int.(readdlm("./application/artificial data/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_1d_tau_tde.csv"))
...
optimal_d_tde = Int.(readdlm("./application/artificial data/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_1d_optimal_d_tde.csv"))
...
L_tde = readdlm("./application/artificial data/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_1d_FNN_tde.csv")
...
RQA_tde = readdlm("./application/artificial data/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_1d_RQA_tde.csv")
