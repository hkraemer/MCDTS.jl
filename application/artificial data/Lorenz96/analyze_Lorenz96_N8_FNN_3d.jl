...
Fs = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_Fs.csv")

tau_tde = Int.(readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_tau_tde.csv"))
tau_MCDTSs = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_tau_MCDTS.csv")
...
ts_MCDTSs = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_ts_MCDTS.csv")
ts_MCDTS = []
...
optimal_d_tde = Int.(readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_optimal_d_tde.csv"))
optimal_d_mcdts = Int.(readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_optimal_d_mcdts.csv"))

L_tde = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_FNN_tde.csv")
L_mcdts = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_FNN_mcdts.csv")

RQA_tde = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_RQA_tde.csv")
RQA_mcdts = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_RQA_mcdts.csv")
RQA_ref = readdlm("./application/artificial data/Lorenz96/Results/Reference/results_Lorenz96_N_$(N)_ref_RQA_ref.csv")

##
λs = readdlm("./application/artificial data/Lorenz96/Lyapunov spectrum/Lyaps_Lo96_N_$(N)_4.csv")
λs = λs[1:2:end,:]
