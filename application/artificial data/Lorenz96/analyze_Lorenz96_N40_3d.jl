...
# trial 1: N=40; Fs = 3.5:0.004:5, MCDTS (80 trials), ts-length = 5000, dt = 0.1, fixed ic's, L_thres = 0
...
# bind variables
params = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_params.csv")
N,dt,total,ε,dmax,lmin,trials,taus,Tw,t_idx = params
Fs = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_Fs.csv")

tau_tde = Int.(readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_tau_tde.csv"))
tau_pecs = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_tau_pec.csv")
tau_MCDTSs = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_tau_MCDTS.csv")
...
ts_pecs = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_ts_pec.csv")
ts_MCDTSs = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_ts_MCDTS.csv")
ts_pec = []
ts_MCDTS = []
...
optimal_d_tde = Int.(readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_optimal_d_tde.csv"))
optimal_d_pec = Int.(readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_optimal_d_pec.csv"))
optimal_d_mcdts = Int.(readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_optimal_d_mcdts.csv"))

L_tde = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_L_tde.csv")
L_pec = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_L_pec.csv")
L_mcdts = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_L_mcdts.csv")

RQA_tde = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_RQA_tde.csv")
RQA_pec = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_RQA_pec.csv")
RQA_mcdts = readdlm("./application/artificial data/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_3d_RQA_mcdts.csv")
