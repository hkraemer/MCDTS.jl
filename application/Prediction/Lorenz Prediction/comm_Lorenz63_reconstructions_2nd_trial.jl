...
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/x1.csv", x1)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/x2.csv", x2)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/y1.csv", y1)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/y2.csv", y2)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/x1_n.csv", x1_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/x2_n.csv", x2_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/y1_n.csv", y1_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/y2_n.csv", y2_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/data_sample.csv", data_sample)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/data_sample_n.csv", data_sample_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tr.csv", tr)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_cao.csv", Y_cao)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_cao_n.csv", Y_cao_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_cao.csv", τ_cao)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_cao_n.csv", τ_cao_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_kennel.csv", Y_kennel)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_kennel_n.csv", Y_kennel_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_kennel.csv", τ_kennel)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_kennel_n.csv", τ_kennel_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_hegger.csv", Y_hegger)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_hegger_n.csv", Y_hegger_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_hegger.csv", τ_hegger)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_hegger_n.csv", τ_hegger_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_pec.csv", Y_pec)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_pec_n.csv", Y_pec_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_pec.csv", τ_pec)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_pec_n.csv", τ_pec_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_mcdts.csv", Y_mcdts)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/Y_mcdts_n.csv", Y_mcdts_n)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_mcdts.csv", τ_mcdts)
writedlm("./application/artificial data/Lorenz Prediction/2nd Trial/Results 1/tau_mcdts_n.csv", τ_mcdts_n)
