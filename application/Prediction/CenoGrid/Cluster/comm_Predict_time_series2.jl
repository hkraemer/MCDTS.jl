...
writedlm("results_CENOGRID_prediction_zeroth2.csv", prediction_zeroth)
writedlm("results_CENOGRID_prediction_linear2.csv", prediction_linear)
writedlm("results_CENOGRID_MSEs_zeroth2.csv", MSEs_zeroth)
writedlm("results_CENOGRID_MSEs_linear2.csv", MSEs_linear)
