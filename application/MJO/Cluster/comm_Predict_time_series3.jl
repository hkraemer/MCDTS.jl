...
tree = MCDTS.mc_delay(data_sample, w1, (L)->(MCDTS.softmaxL(L,β=2.)), taus1, trials2; tws = 2:taus1[end], verbose=true, threshold = 0.0001)
best_node = MCDTS.best_embedding(tree)
...
writedlm("results_MJO_prediction_zeroth3.csv", prediction_zeroth)
writedlm("results_MJO_prediction_linear3.csv", prediction_linear)
writedlm("results_MJO_MSEs_zeroth3.csv", MSEs_zeroth)
writedlm("results_MJO_MSEs_linear3.csv", MSEs_linear)
#
# # mcdts FNN
# println("MCDTS FNN")
