...
# mcdts L
println("MCDTS L")
tree = MCDTS.mc_delay(Dataset(x1), w1, (L)->(MCDTS.softmaxL(L,β=2.)), taus1, trials1; tws = 2:taus1[end], verbose=true, threshold = 0.0001)
...
writedlm("results_MJO_prediction_zeroth2.csv", prediction_zeroth)
writedlm("results_MJO_prediction_linear2.csv", prediction_linear)
writedlm("results_MJO_MSEs_zeroth2.csv", MSEs_zeroth)
writedlm("results_MJO_MSEs_linear2.csv", MSEs_linear)
