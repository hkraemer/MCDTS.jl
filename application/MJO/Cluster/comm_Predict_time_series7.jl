...
writedlm("results_MJO_prediction_zeroth7.csv", prediction_zeroth)
writedlm("results_MJO_prediction_linear7.csv", prediction_linear)
writedlm("results_MJO_MSEs_zeroth7.csv", MSEs_zeroth)
writedlm("results_MJO_MSEs_linear7.csv", MSEs_linear)
