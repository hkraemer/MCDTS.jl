...
writedlm("results_MJO_prediction_zeroth4.csv", prediction_zeroth)
writedlm("results_MJO_prediction_linear4.csv", prediction_linear)
writedlm("results_MJO_MSEs_zeroth4.csv", MSEs_zeroth)
writedlm("results_MJO_MSEs_linear4.csv", MSEs_linear)
