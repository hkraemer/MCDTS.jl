...
writedlm("results_MJO_prediction_zeroth5.csv", prediction_zeroth)
writedlm("results_MJO_prediction_linear5.csv", prediction_linear)
writedlm("results_MJO_MSEs_zeroth5.csv", MSEs_zeroth)
writedlm("results_MJO_MSEs_linear5.csv", MSEs_linear)
#
#
# # mcdts PRED KL
