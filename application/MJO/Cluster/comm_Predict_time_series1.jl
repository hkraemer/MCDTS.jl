...
writedlm("results_MJO_prediction_zeroth1.csv", prediction_zeroth)
writedlm("results_MJO_prediction_linear1.csv", prediction_linear)
writedlm("results_MJO_MSEs_zeroth1.csv", MSEs_zeroth)
writedlm("results_MJO_MSEs_linear1.csv", MSEs_linear)
