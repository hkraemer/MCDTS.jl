...
# bind variables
params = readdlm("./application/Recurrence Analysis/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_params.csv")
N,dt,total,ε,dmax,lmin,trials,taus,Tw,t_idx = params
Fs = readdlm("./application/Recurrence Analysis/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_Fs.csv")
...
tau_MCDTSs = readdlm("./application/Recurrence Analysis/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_tau_MCDTS.csv")
...
ts_MCDTSs = readdlm("./application/Recurrence Analysis/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_ts_MCDTS.csv")
ts_MCDTS = []
...
optimal_d_mcdts = Int.(readdlm("./application/Recurrence Analysis/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_optimal_d_mcdts.csv"))
...
L_mcdts = readdlm("./application/Recurrence Analysis/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_FNN_mcdts.csv")
...
RQA_mcdts = readdlm("./application/Recurrence Analysis/Lorenz96/Results/3 dimensional input/trial $(trial)/results_Lorenz96_N_$(N)_FNN_3d_RQA_mcdts.csv")
RQA_ref = readdlm("./application/Recurrence Analysis/Lorenz96/Results/Reference/results_Lorenz96_N_$(N)_ref_RQA_ref.csv")

##
λs = readdlm("./application/Recurrence Analysis/Lorenz96/Lyapunov spectrum/Lyaps_Lo96_N_$(N)_4.csv")
λs = λs[1:2:end,:]
