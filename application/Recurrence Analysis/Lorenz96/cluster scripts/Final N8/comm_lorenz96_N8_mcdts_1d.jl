...
writedlm("results_Lorenz96_N_$(N)_mcdts_1d_params.csv", params)
writedlm("results_Lorenz96_N_$(N)_mcdts_1d_Fs.csv", Fs)

varnames = ["tau_MCDTS", "ts_MCDTS", "optimal_d_mcdts", "RQA_mcdts", "L_mcdts", "RP_frac_mcdts"]

for i = 1:length(varnames)
    writestr = "results_Lorenz96_N_$(N)_mcdts_1d_"*varnames[i]*".csv"
    data = []
