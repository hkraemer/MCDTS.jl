...
if FNN
    tau_MCDTSs = readdlm("./MCDTS FNN/results_Lorenz96_N_$(N)_FNN_1d_tau_MCDTS.csv")
    ts_MCDTSs = readdlm("./MCDTS FNN/results_Lorenz96_N_$(N)_FNN_1d_ts_MCDTS.csv")
    optimal_d_mcdts = Int.(readdlm("./MCDTS FNN/results_Lorenz96_N_$(N)_FNN_1d_optimal_d_mcdts.csv"))
    FNN_mcdts = readdlm("./MCDTS FNN/results_Lorenz96_N_$(N)_FNN_1d_FNN_mcdts.csv")
    RQA_mcdts = readdlm("./MCDTS FNN/results_Lorenz96_N_$(N)_FNN_1d_RQA_mcdts.csv")
    RP_frac_mcdts = readdlm("./MCDTS FNN/results_Lorenz96_N_$(N)_FNN_1d_RP_frac_mcdts.csv")

else
    tau_MCDTSs = readdlm("./MCDTS L/results_Lorenz96_N_$(N)_mcdts_1d_tau_MCDTS.csv")
    tau_pec = readdlm("./PECUZAL/results_Lorenz96_N_$(N)_pec_1d_tau_pec.csv")
    ts_MCDTSs = readdlm("./MCDTS L/results_Lorenz96_N_$(N)_mcdts_1d_ts_MCDTS.csv")
    ts_pec = readdlm("./PECUZAL/results_Lorenz96_N_$(N)_pec_1d_ts_pec.csv")
    optimal_d_mcdts = Int.(readdlm("./MCDTS L/results_Lorenz96_N_$(N)_mcdts_1d_optimal_d_mcdts.csv"))
    optimal_d_pec = Int.(readdlm("./PECUZAL/results_Lorenz96_N_$(N)_pec_1d_optimal_d_pec.csv"))
    L_mcdts = readdlm("./MCDTS L/results_Lorenz96_N_$(N)_mcdts_1d_L_mcdts.csv")
    L_pec = readdlm("./PECUZAL/results_Lorenz96_N_$(N)_pec_1d_L_pec.csv")

    RQA_pec = readdlm("./PECUZAL/results_Lorenz96_N_$(N)_pec_1d_RQA_pec.csv")
    RP_frac_pec = readdlm("./PECUZAL/results_Lorenz96_N_$(N)_pec_1d_RP_frac_pec.csv")

    RQA_mcdts = readdlm("./MCDTS L/results_Lorenz96_N_$(N)_mcdts_1d_RQA_mcdts.csv")
    RP_frac_mcdts = readdlm("./MCDTS L/results_Lorenz96_N_$(N)_mcdts_1d_RP_frac_mcdts.csv")
end
...
MSE_Pecuzal = zeros(10)
MSE_MCDTS_L = zeros(10)
MSE_MCDTS_FNN = zeros(10)
MSE_Cao = zeros(10)
MSE_Kennel = zeros(10)
MSE_Hegger = zeros(10)
...
for i = 1:size(RQA_ref,2)-1
    ...
    if FNN
        ...
        MSE_MCDTS_FNN[i] = mean((RQA_mcdts[:,i] .- RQA_ref[:,i]).^2 ./ RQA_ref[:,i])
        writedlm("./MSEs/MSE_MCDTS_FNN.csv", MSE_MCDTS_FNN)
        if tde == 1
        ...
        MSE_Pecuzal[i] = mean((RQA_pec[:,i] .- RQA_ref[:,i]).^2 ./ RQA_ref[:,i])
        MSE_MCDTS_L[i] = mean((RQA_mcdts[:,i] .- RQA_ref[:,i]).^2 ./ RQA_ref[:,i])

        writedlm("./MSEs/MSE_Pecuzal.csv", MSE_Pecuzal)
        writedlm("./MSEs/MSE_MCDTS_L.csv", MSE_MCDTS_L)
...
if FNN
    ...
    MSE_MCDTS_FNN[10] = mean(RP_frac_mcdts)
    if tde == 1
    ...
    MSE_Pecuzal[10] = mean(RP_frac_pec)
    MSE_MCDTS_L[10] = mean(RP_frac_mcdts)
    if tde == 1
        MSE_Cao[10] = mean(RP_frac_tde)
    elseif tde == 2
        MSE_Kennel[10] = mean(RP_frac_tde)
...
# For plotting in Matlab, save the MSE-values here
