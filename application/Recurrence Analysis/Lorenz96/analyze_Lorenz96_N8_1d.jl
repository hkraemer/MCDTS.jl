...
# bind variables
params = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_params.csv")
N,dt,total,ε,dmax,lmin,trials,taus,Tw,t_idx = params
Fs = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_Fs.csv")
...
tau_pecs = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_tau_pec.csv")
tau_MCDTSs = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_tau_MCDTS.csv")
...
ts_pecs = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_ts_pec.csv")
ts_MCDTSs = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_ts_MCDTS.csv")
ts_pec = []
ts_MCDTS = []
...
optimal_d_pec = Int.(readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_optimal_d_pec.csv"))
optimal_d_mcdts = Int.(readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_optimal_d_mcdts.csv"))
...
L_pec = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_L_pec.csv")
L_mcdts = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_L_mcdts.csv")
...
RQA_pec = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_RQA_pec.csv")
RQA_mcdts = readdlm("./application/Recurrence Analysis/Lorenz96/Results/1 dimensional input/trial $(trial)/results_Lorenz96_N_8_1d_RQA_mcdts.csv")
RQA_ref = readdlm("./application/Recurrence Analysis/Lorenz96/Results/Reference/results_Lorenz96_N_8_ref_RQA_ref.csv")
