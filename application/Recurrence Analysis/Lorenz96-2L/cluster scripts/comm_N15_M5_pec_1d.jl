...
writestr = "./slow variable/results_Lorenz96_L2_N$(N)_M$(M)_1d_tau_pec.csv"
writedlm(writestr, τ_pec)
writestr = "./slow variable/results_Lorenz96_L2_N$(N)_M$(M)_1d_ts_pec.csv"
writedlm(writestr, ts_pec)
writestr = "./slow variable/results_Lorenz96_L2_N$(N)_M$(M)_1d_optimal_d_pec.csv"
writedlm(writestr, optimal_d_pec)
writestr = "./slow variable/results_Lorenz96_L2_N$(N)_M$(M)_1d_L_pec.csv"
