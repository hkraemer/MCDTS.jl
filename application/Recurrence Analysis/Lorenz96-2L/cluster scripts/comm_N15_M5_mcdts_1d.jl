...
writestr = "./slow variable/results_Lorenz96_L2_N$(N)_M$(M)_1d_tau_mcdts.csv"
writedlm(writestr, best_node.τs)
writestr = "./slow variable/results_Lorenz96_L2_N$(N)_M$(M)_1d_ts_mcdts.csv"
writedlm(writestr, best_node.ts)
writestr = "./slow variable/results_Lorenz96_L2_N$(N)_M$(M)_1d_optimal_d_mcdts.csv"
writedlm(writestr, optimal_d_mcdts)
writestr = "./slow variable/results_Lorenz96_L2_N$(N)_M$(M)_1d_L_mcdts.csv"
