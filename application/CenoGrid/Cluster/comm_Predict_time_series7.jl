...
writedlm("results_CENOGRID_prediction_zeroth7.csv", prediction_zeroth)
writedlm("results_CENOGRID_prediction_linear7.csv", prediction_linear)
writedlm("results_CENOGRID_MSEs_zeroth7.csv", MSEs_zeroth)
writedlm("results_CENOGRID_MSEs_linear7.csv", MSEs_linear)
