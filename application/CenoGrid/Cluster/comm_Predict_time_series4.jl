...
writedlm("results_CENOGRID_prediction_zeroth4.csv", prediction_zeroth)
writedlm("results_CENOGRID_prediction_linear4.csv", prediction_linear)
writedlm("results_CENOGRID_MSEs_zeroth4.csv", MSEs_zeroth)
writedlm("results_CENOGRID_MSEs_linear4.csv", MSEs_linear)
